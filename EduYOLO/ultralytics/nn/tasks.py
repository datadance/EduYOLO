...
POSE_CLASS = (Pose,)
OBB_CLASS = (OBB,)
C3K2_CLASS = (C3k2_RFAConv, )
A2C2F_CLASS = (A2C2f,)
C2PSA_CLASS = (C2PSA, C2BRA, )
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            MANet_Star, PSConv, RepHMS, CSP_MSCB_SC, LoGStem, GFM,
            ...
            c2 = m.channel
                   ...
                   TripletAttention, CoordAtt, CBAM, BAMBlock, LSKBlock, ScConv, EMSConv, EMSConvP,
